...
namespace ResearchProjectManagement.DAL.Contexts;
...
public partial class Su25researchDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ProjectId).HasName("PK__Research__761ABED08C60C1D8");
            ...
            entity.HasOne(d => d.LeadResearcher).WithMany(p => p.ResearchProjects)
                ...
                .HasConstraintName("FK__ResearchP__LeadR__5165187F");
        });

        modelBuilder.Entity<Researcher>(entity =>
        {
            entity.HasKey(e => e.ResearcherId).HasName("PK__Research__7CC06F05604CB97F");

            entity.ToTable("Researcher");

            entity.HasIndex(e => e.Email, "UQ__Research__A9D10534DCCE99DA").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__UserAcco__1788CCACA7006272");

            entity.ToTable("UserAccount");

            entity.HasIndex(e => e.Email, "UQ__UserAcco__A9D10534ABC8B6FC").IsUnique();
