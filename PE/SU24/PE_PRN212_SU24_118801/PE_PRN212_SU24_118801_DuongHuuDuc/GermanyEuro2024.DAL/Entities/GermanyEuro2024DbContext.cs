...
namespace GermanyEuro2024.DAL.Entities;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-S8DBQOH\\DUCDUONG;uid=sa;pwd=12345;database=GermanyEuro2024DB;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<FootballPlayer>(entity =>
        {
            entity.HasKey(e => e.PlayerId).HasName("PK__Football__4A4E74A898741EBC");
        ...
        {
            entity.HasKey(e => e.FootballTeamId).HasName("PK__Football__B287F27BFBD96AD2");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__UEFAAcco__349DA586F5E0F58F");

            entity.ToTable("UEFAAccount");

            entity.HasIndex(e => e.AccountEmail, "UQ__UEFAAcco__FC770D331C92AE02").IsUnique();
