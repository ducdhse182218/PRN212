...
public partial class Sp25PlantInventoryDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.InventoryId).HasName("PK__Inventor__F5FDE6D38AD3D4E5");
        ...
        {
            entity.HasKey(e => e.PlantId).HasName("PK__Plant__98FE46BC72FE5C3C");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__SystemUs__1788CCAC5C2800B3");

            entity.ToTable("SystemUser");

            entity.HasIndex(e => e.UserEmail, "UQ__SystemUs__08638DF8F6F46E23").IsUnique();
