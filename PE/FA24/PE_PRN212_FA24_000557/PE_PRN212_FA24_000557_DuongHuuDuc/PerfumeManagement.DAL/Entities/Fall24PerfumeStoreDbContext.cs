...
public partial class Fall24PerfumeStoreDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.PerfumeId).HasName("PK__PerfumeI__A6B3A28F25F7D941");
        ...
        {
            entity.HasKey(e => e.ProductionCompanyId).HasName("PK__Producti__DAD1A103DA9ADF87");
        ...
        {
            entity.HasKey(e => e.PsaccountId).HasName("PK__PSAccoun__776C85AF75211F3D");

            entity.ToTable("PSAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__PSAccoun__49A14740B22F0402").IsUnique();
